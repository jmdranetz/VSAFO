...
headlist={'gaslat_r','gaslat_l','gasmed_r','gasmed_l','tibant_r','tibant_l','soleus_r','soleus_l','bflh_r','bflh_l','recfem_r','recfem_l','vasmed_r','vasmed_l'};
fi=strcat('C:\OpenSim\4.1\Models\VSAFO\',subject,'\CMC\',cond,'\',subject,'_',cond,'_p');
fe='_controls.sto';
Outname=strcat('C:\OpenSim\4.1\Models\VSAFO\',subject,'\Interpolated_Results\',cond,'_CMCactivation.mat');
...
%     figure
%     hold on
%     plot(0:.1:99.9,avmat(j,:))
%     title(strcat('0mm AFO',{' '},headlist{j}))
%     xlabel('Percent Gait Cycle')
%     ylabel('Muscle Force (N)')
%     hold off
end
save(Outname,'avmat','headlist');