...
headlist={'hip_flexion_r','hip_flexion_l','knee_angle_r','knee_angle_l','ankle_angle_r','ankle_angle_l'};
fi=strcat('C:\OpenSim\4.1\Models\VSAFO\',subject,'\IK\',cond,'\',cond,'_p');
fe='.mot';
Outname=strcat('C:\OpenSim\4.1\Models\VSAFO\',subject,'\Interpolated_Results\',cond,'_IK.mat');
